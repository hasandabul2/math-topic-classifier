...
import { Brain, FileSpreadsheet, History, CreditCard, Shield, LogOut, Menu, X, Moon, Sun } from 'lucide-react'
...
export default function Navbar() {
    ...
    const navItems = [
        { path: '/', label: 'Classifier', icon: Brain },
        { path: '/bulk', label: 'Bulk', icon: FileSpreadsheet },
