            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-10 max-w-md w-full text-center">
                {isSuccess ? (
                    <>
                        ...
                        <h1 className="text-2xl font-extrabold text-slate-800 mb-2">Payment Successful! 🎉</h1>
                        ...
                        <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl mb-6">
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <span className="font-semibold text-emerald-700 capitalize">{tier || 'Pro'} Plan Active</span>
                            </div>
                        </div>
                    </>
                ) : (
